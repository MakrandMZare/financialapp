            ...
            <tr key={u.id}>
              <td>
                <input
                  aria-label="Username"
                  value={u.username}
                  onChange={(e) => setUsers(users.map(user => user.id === u.id ? {...user, username: e.target.value} : user))}
                />
              </td>
              <td>
                <input
                  aria-label="Mobile"
                  value={u.mobile}
                  onChange={(e) => setUsers(users.map(user => user.id === u.id ? {...user, mobile: e.target.value} : user))}
                />
              </td>
              <td>
                <input
                  ...
                  placeholder="Email"
                  value={u.email || ""}
                  onChange={(e) => setUsers(users.map(user => user.id === u.id ? {...user, email: e.target.value} : user))}
                />
              </td>
              <td>
