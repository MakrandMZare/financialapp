...
export default function Transactions() {
  ...
  const [editingTxn, setEditingTxn] = useState<Record<number, Partial<Transaction>>>({});
  ...
  const updateEditingTxn = (id: number, field: keyof Transaction, value: any) => {
    setEditingTxn((prev) => ({
      ...prev,
            ...
            <tr key={t.id}>
              <td>
                <input
                  ...
                  onChange={(e) => updateEditingTxn(t.id, 'txn_date', e.target.value)}
                />
              </td>
              <td>
                <select
                  ...
                  onChange={(e) => updateEditingTxn(t.id, 'txn_type', e.target.value as "Paid" | "Received")}
                >
              ...
              <td>
                <input
                  ...
                  onChange={(e) => updateEditingTxn(t.id, 'amount', Number(e.target.value))}
                />
              </td>
              <td>
                <input
                  ...
                  onChange={(e) => updateEditingTxn(t.id, 'notes', e.target.value)}
                />
              </td>
              <td>
